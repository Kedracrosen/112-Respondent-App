...
class EmrJoinChannelVideo extends StatefulWidget {
  a? notif;
  EmrJoinChannelVideo({this.notif});
  @override
  State<StatefulWidget> createState() => _State();
}

class _State extends State<EmrJoinChannelVideo> {
...
// Init firestore and geoFlutterFire
 ...
 void _findNearbyEmrs(double mylat,double mylng,myaddress) async{
  ...
  _addListeners() {
    _engine.setEventHandler(RtcEngineEventHandler(
      ...
      userJoined: (uid, elapsed) {
        ...
        Fluttertoast.showToast(msg: "User joined");
      ...
      userOffline: (uid, reason) {
        ...
        Fluttertoast.showToast(msg: "User Offline");
  ...
  _joinChannel(id) async {
    print('AGOMPH:tyingToJoin ');

    if (defaultTargetPlatform == TargetPlatform.android) {
      await [Perm.Permission.microphone, Perm.Permission.camera].request();
    }
    try{
      print('the channel id of video to be joined'+widget.notif!.channelId!);
    await _engine.joinChannel(config.token, "def_chan", null, int.parse(id));
    }catch(e){
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text('Connecting you to '+widget.notif!.name!+'.... ',
                                style: TextStyle(
                                    color:
                                    AppColors.white.withOpacity(0.93),
                                    fontWeight: FontWeight.bold)),
                            SizedBox(
                              height: 5,
                            ),
