...
class Chat extends StatelessWidget {
  ...
  Chat({Key? key, @required this.peerId,this.title}) : super(key: key);
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key? key, @required this.peerId,this.title}) : super(key: key);
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget buildItem(int index, DocumentSnapshot document) {
    if (document != null && document.get('category')== widget.title) {
